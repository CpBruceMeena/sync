                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/discovery.GroupDetailResponse"
                            }
                        }
                    },
                    "500": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/discovery.UserResult"
                            }
                        }
                    },
                    "400": {
        ...
        "discovery.GroupDetailResponse": {
            ...
            "properties": {
                ...
                "members": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/discovery.GroupMemberResponse"
                    }
                },
                "name": {
                    "type": "string"
